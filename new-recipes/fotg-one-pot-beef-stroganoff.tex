...
\renewcommand{\myFilename}{fotg-one-pot-beef-stroganoff}
...
\sbox{\myMethod}{
  \begin{minipage}[t]{\the\dimexpr 0.55\textwidth - 2em}\raggedright
    ...
    \begin{enumerate}
      ...
      \item Reduce heat to medium. Add the mushrooms and sauté 5 minutes, stirring
        infrequently. Add the onions and continue to sauté an additional 5 minutes.
