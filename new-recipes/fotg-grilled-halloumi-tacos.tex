...
\renewcommand{\myFilename}{fotg-grilled-halloumi-tacos.jpg}
...
\sbox{\myIngred}{%
  \begin{minipage}[t]{\the\dimexpr 0.35\textwidth}\raggedright % chktex 1
    \textbf{Ingredients}
    \begin{itemize}
      \item 7 oz halloumi cheese (to equal 6 slices)
      \item 1 teaspoon olive oil
      \item 1 small red onion quartered
      \item 1 pepper (jalapeño if you like things spicy, poblano for medium heat, or
...
\sbox{\myMethod}{%
  \begin{minipage}[t]{\the\dimexpr 0.55\textwidth - 2em}\raggedright % chktex 1 chktex 8
...
\begin{tabular}{ll}
  \begin{minipage}[t]{0.6\textwidth}\raggedright % chktex 1
