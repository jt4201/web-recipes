...
\renewcommand{\myFilename}{ByB-spicy-teriyaki-grilled-steak-kebabs}
...
\sbox{\myIngred}{
  \begin{minipage}[t]{\the\dimexpr0.35\textwidth}
    ...
    \begin{itemize}
      ...
      \item 3--4 zuchinni cut into 1 inch slices
  ...
  \begin{minipage}[t]{\the\dimexpr0.6\textwidth-2em}
    ...
    \begin{enumerate}
      ...
      \item **Make sure you soak your wooden (or use metal) skewers for 30 minutes
        this helps them so they don't burn while on the hot grill.
    \end{enumerate}
  \end{minipage}
}
